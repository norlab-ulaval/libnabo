...
# =================================================================================================
#
# Execute build matrix specified in .env.build_matrix.libnabo
#
# Redirect the execution to 'nbs_execute_compose_over_build_matrix.bash' from the norlab-build-system library
#
# Usage:
#   $ bash nabo_crawl_libnabo_build_matrix.bash [<optional flag>] [-- <any docker cmd+arg>]
#
#   $ bash nabo_crawl_libnabo_build_matrix.bash -- build --dry-run
#
...
DOTENV_BUILD_MATRIX_REALPATH=${NABO_BUILD_SYSTEM_PATH}/.env.build_matrix.libnabo.release
