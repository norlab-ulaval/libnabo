...
#
# Usage:
#   $ bash nabo_install_libnabo_ubuntu.bash [<optional flag>]
#
# Arguments:
...
#   - execute `nabo_install_dependencies_ubuntu.bash` first
#
# =================================================================================================
...
LIBNABO_BUILD_DOXYGEN_FLAG=OFF
...
cd "${NABO_PATH}/build_system" || exit
...
function print_help_in_terminal() {
  ...
  Global
    - Read the array APPEND_TO_CMAKE_FLAG
      ...
      Usage:
       $ export APPEND_TO_CMAKE_FLAG=( -D CMAKE_INSTALL_PREFIX=/opt ) && source nabo_install_libnabo_ubuntu.bash
...
# ....Cmake flags..................................................................................
CMAKE_FLAGS=( -D CMAKE_BUILD_TYPE="${CMAKE_BUILD_TYPE}" -D LIBNABO_BUILD_TESTS="${BUILD_TESTS_FLAG}" -D LIBNABO_BUILD_DOXYGEN="${LIBNABO_BUILD_DOXYGEN_FLAG}" "${APPEND_TO_CMAKE_FLAG[@]}" )

# (CRITICAL) ToDo: validate >> LIBNABO_BUILD_DOXYGEN install dir
...
print_msg "Directories (pre libnabo install)$(tree -L 2 "${NBS_LIB_INSTALL_PATH}")"
...
if [[ $TEST_RUN  == true ]]; then
  ...
  if [[ ${LIBNABO_BUILD_DOXYGEN_FLAG} = ON ]]; then
      make doc
  fi
