...
# =================================================================================================
#
# Libnabo dependencies installer
#
# Usage:
#   $ source nabo_install_dependencies_ubuntu.bash [--test-run]
#
# =================================================================================================
...
cd "${NABO_PATH}/build_system" || cd "${NABO_PATH}" || exit 1

NBS_PATH=${NBS_PATH:-"${NABO_PATH}/build_system/utilities/norlab-build-system"}
...
print_formated_script_header "nabo_install_dependencies_ubuntu.bash (${IMAGE_ARCH_AND_OS:?err})" "${MSG_LINE_CHAR_INSTALLER}"
...
# .................................................................................................
teamcity_service_msg_blockOpened "Install Libnabo dependencies › Boost"
...
teamcity_service_msg_blockClosed
# .................................................................................................
teamcity_service_msg_blockOpened "Install Libnabo dependencies › Eigen"
...
echo " " && print_msg_done "Libnabo dependencies installed"
print_formated_script_footer "nabo_install_dependencies_ubuntu.bash (${IMAGE_ARCH_AND_OS})" "${MSG_LINE_CHAR_INSTALLER}"
# ====Teardown=====================================================================================
cd "${TMP_CWD}"
