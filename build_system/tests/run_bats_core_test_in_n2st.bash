#!/bin/bash
# =================================================================================================
# Execute libnabo repo shell script tests via 'norlab-shell-script-tools' library
#
# Note the script can be executed from anywhere as long as its inside the libnabo repository
#
# Usage:
